...
import { requireFacilitator, requireFacilitatorForCard, requireGuestUser } from '@/middleware/auth'
...
router.patch('/:id/move', requireGuestUser, requireFacilitatorForCard, moveCard) // PATCH /api/cards/:id/move
router.patch('/:id/position', requireGuestUser, requireFacilitatorForCard, updateCardPosition) // PATCH /api/cards/:id/position
